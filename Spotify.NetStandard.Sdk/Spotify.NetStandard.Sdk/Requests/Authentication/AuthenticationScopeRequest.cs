...
namespace Spotify.NetStandard.Sdk
{
    ...
    /// </summary>
    public class AuthenticationScopeRequest
    {
        #region Images
        /// <summary>
        ...
        /// </summary>
        public bool? ImageUserGeneratedContentUpload { get; set; }
        #endregion Images
        ...
        #region Multiple Authentication Scope Helpers
        /// <summary>
        ...
        /// </summary>
        public static AuthenticationScopeRequest ReadAllAccess => new AuthenticationScopeRequest().AddReadAllAccess();
        ...
        /// </summary>
        public static AuthenticationScopeRequest ModifyAllAccess => new AuthenticationScopeRequest().AddModifyAllAccess();
        ...
        /// </summary>
        public static AuthenticationScopeRequest PlaylistAll => new AuthenticationScopeRequest().AddPlaylistAll();
        ...
        /// </summary>
        public static AuthenticationScopeRequest SpotifyConnectAll => new AuthenticationScopeRequest().AddSpotifyConnectAll();
        ...
        /// </summary>
        public static AuthenticationScopeRequest ListeningHistoryAll => new AuthenticationScopeRequest().AddListeningHistoryAll();
        ...
        /// </summary>
        public static AuthenticationScopeRequest PlaybackAll => new AuthenticationScopeRequest().AddPlaybackAll();
        ...
        /// </summary>
        public static AuthenticationScopeRequest UsersAll => new AuthenticationScopeRequest().AddUsersAll();

        /// <summary>
        /// Returns a new AuthorisationScopeRequest object with all scopes within the confines of Users set to true
        /// Usage : AuthorisationScopeRequest.FollowAll
        /// </summary>
        public static AuthenticationScopeRequest FollowAll => new AuthenticationScopeRequest().AddFollowAll();
        ...
        /// </summary>
        public static AuthenticationScopeRequest LibraryAll => new AuthenticationScopeRequest().AddLibraryAll();

        /// <summary>
        /// Returns a new AuthorisationScopeRequest object with all scopes set to true
        /// Usage : AuthorisationScopeRequest.AllPermissions
        /// </summary>
        public static AuthenticationScopeRequest AllPermissions =>
        ...
        #endregion Multiple Authentication Scope Helpers
    }
}
